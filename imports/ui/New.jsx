...
export default class New extends Component {
  submitPLayer(event){
    ...
    createdAt: new Date()
     ...
     console.log('success, player submitter');
    browserHistory.push('/');
  }
  render(){
    return (
      <div className="row">
        ...
        <div className="input-field col s6">
          ...
          <select className="browser-default" ref="ballManipulation">
            ...
            <option value="1" > Some Skills </option>
            <option value="2" > Good Skills </option>
            <option value="3" > Excellent Skills </option>
          </select>
        </div>
        <div className="input-field col s6">
        ...
        <div className="row">
          <div className="input-field col s6">
            ...
            <div className="input-field col s6">
              <button className="btn waves-light waves-effect" type="submit" name="action">
